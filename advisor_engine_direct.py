...
def get_advisor_response(system_prompt: str, conversation_history: List)-> str:
    """
    This function sends the conversation to Ollama (llama3.2) and get an advisor response.

    Args:
        system_prompt: the instruction manual with all degree data
    ...
    try:
        ...
        return f"I'm having troble connecting to llama8200. Error: {str(e)}"
